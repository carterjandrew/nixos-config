{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-cc067315-dcc5-4d32-912a-9176a24e8659" = [];
      "Alacritty.desktop"."New" = "Meta+Return,none,New Terminal";
      "Alacritty.desktop"."_launch" = [];
      "KDE Keyboard Layout Switcher"."Switch to Next Keyboard Layout" = [];
      "bismuth"."decrease_master_size" = "none,,Decrease Master Area Size";
      ...
      "bismuth"."focus_next_window" = "none,,Focus Next Window";
      "bismuth"."focus_prev_window" = "none,,Focus Previous Window";
      "bismuth"."focus_right_window" = "Meta+L";
      "bismuth"."focus_upper_window" = "Meta+K";
      "bismuth"."increase_master_size" = "none,,Increase Master Area Size";
      ...
      "bismuth"."move_window_to_next_pos" = "none,,Move Window to the Next Position";
      "bismuth"."move_window_to_prev_pos" = "none,,Move Window to the Previous Position";
      ...
      "bismuth"."push_window_to_master" = "none,Meta+Return,Push Active Window to Master Area";
      "bismuth"."rotate" = "Meta+R";
      "bismuth"."rotate_part" = "Meta+Shift+R";
      "bismuth"."rotate_reverse" = "none,,Rotate (Reverse)";
      "bismuth"."toggle_float_layout" = "Meta+Shift+F";
      "bismuth"."toggle_monocle_layout" = "Meta+M";
      "bismuth"."toggle_quarter_layout" = "none,,Toggle Quarter Layout";
      "bismuth"."toggle_spiral_layout" = "none,,Toggle Spiral Layout";
      "bismuth"."toggle_spread_layout" = "none,,Toggle Spread Layout";
      "bismuth"."toggle_stair_layout" = "none,,Toggle Stair Layout";
      "bismuth"."toggle_three_column_layout" = "none,,Toggle Three Column Layout";
      "bismuth"."toggle_tile_layout" = "none,Meta+T,Toggle Tile Layout";
      ...
      "kwin"."ShowDesktopGrid" = ["Meta+F8" "Meta+Tab,Meta+F8,Show Desktop Grid"];
      ...
      "kwin"."Window Close" = ["Ctrl+Q" "Alt+F4,Alt+F4,Close Window"];
      ...
      "mediacontrol"."nextmedia" = ["Media Next" "Meta+Alt+.,Media Next,Media playback next"];
      "mediacontrol"."pausemedia" = "Media Pause";
      "mediacontrol"."playmedia" = [];
      "mediacontrol"."playpausemedia" = ["Meta+Alt+Space" "Media Play,Media Play,Play/Pause media playback"];
      "mediacontrol"."previousmedia" = ["Meta+Alt+\\" "Media Previous,Media Previous,Media playback previous"];
      ...
      "org.kde.krunner.desktop"."_launch" = ["Alt+Space" "Alt+F2" "Search,Alt+Space" "Alt+F2" "Search,KRunner"];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,7,14,10,11,43.674";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."cc067315-dcc5-4d32-912a-9176a24e8659" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "cc067315-dcc5-4d32-912a-9176a24e8659";
      ...
      "kdeglobals"."General"."fixed" = "JetBrainsMono Nerd Font Mono,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."font" = "JetBrainsMono Nerd Font,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."menuFont" = "JetBrainsMono Nerd Font,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."smallestReadableFont" = "JetBrainsMono Nerd Font,8,-1,5,25,0,0,0,0,0,Light";
      "kdeglobals"."General"."toolBarFont" = "JetBrainsMono Nerd Font,10,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."WM"."activeBackground" = "255,255,255";
      "kdeglobals"."WM"."activeBlend" = "0,0,0";
      "kdeglobals"."WM"."activeFont" = "JetBrainsMono Nerd Font,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."WM"."activeForeground" = "0,0,0";
      "kdeglobals"."WM"."inactiveBackground" = "0,0,0";
      "kdeglobals"."WM"."inactiveBlend" = "75,71,67";
      "kdeglobals"."WM"."inactiveForeground" = "75,71,67";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{e52da074-bbd3-44ef-bb14-1b574cdc7502}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{1ca31a60-7dbf-4de9-b1c7-72957b9473e5}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{6f031ba3-3979-4aec-982a-2fcae59c41f5}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{8022198b-b4be-405a-bd75-72064d160edf}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{e057bce2-bdcf-47d7-82fc-4e58b6d38f3b}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{2f81c6d3-43c0-44f4-a5d9-bd850a47c208}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{111d4c07-d6af-44a9-9786-c8a498e72c23}";
      ...
      "kwinrc"."Desktops"."Id_3" = "d4295020-ec32-4154-a4c3-e7afc1d50412";
      "kwinrc"."Desktops"."Id_4" = "e7b18b48-8da2-4287-ba6e-10c02f2f4e6a";
      "kwinrc"."Desktops"."Id_5" = "b1fa7673-b3d0-45f5-92f2-80aada15aa1e";
      "kwinrc"."Desktops"."Id_6" = "8bff3e3a-86a1-4302-827f-56bcfd186632";
      "kwinrc"."Desktops"."Id_7" = "92c88862-c6cb-495d-8e82-c5efa0de1e4f";
      "kwinrc"."Desktops"."Id_8" = "a85588a2-f982-4191-90f3-833069dd1d12";
      "kwinrc"."Desktops"."Id_9" = "cbbdf0a5-125d-415e-92b2-4cec7a97b731";
