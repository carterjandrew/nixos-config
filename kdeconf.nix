{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-61e0cf0d-e01e-4a62-985f-f34f80ec193c" = [];
      ...
      "kwin"."ShowDesktopGrid" = ["Meta+Tab" "Meta+F8"];
      ...
      "kwin"."Window Close" = ["Alt+F4" "Ctrl+Q"];
      ...
      "mediacontrol"."nextmedia" = ["Media Next" "Meta+Alt+."];
      "mediacontrol"."pausemedia" = "Media Pause";
      "mediacontrol"."playmedia" = [];
      "mediacontrol"."playpausemedia" = ["Media Play" "Meta+Alt+Space"];
      "mediacontrol"."previousmedia" = ["Meta+Alt+," "Media Previous"];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."61e0cf0d-e01e-4a62-985f-f34f80ec193c" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "61e0cf0d-e01e-4a62-985f-f34f80ec193c";
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "884,576";
      "kdeglobals"."General"."AllowKDEAppsToRememberWindowPositions" = true;
      "kdeglobals"."General"."XftHintStyle" = "hintslight";
      "kdeglobals"."General"."XftSubPixel" = "none";
      "kdeglobals"."General"."fixed" = "JetBrainsMono Nerd Font Mono,10,-1,5,57,0,0,0,0,0,Regular";
      "kdeglobals"."General"."font" = "JetBrainsMono Nerd Font Mono,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."menuFont" = "JetBrainsMono Nerd Font Mono,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."smallestReadableFont" = "JetBrainsMono Nerd Font Mono,8,-1,5,57,0,0,0,0,0,Regular";
      "kdeglobals"."General"."toolBarFont" = "JetBrainsMono Nerd Font Mono,10,-1,5,57,0,0,0,0,0,Regular";
      ...
      "kdeglobals"."KFileDialog Settings"."Speedbar Width" = 163;
      "kdeglobals"."KFileDialog Settings"."View Style" = "DetailTree";
      "kdeglobals"."KScreen"."ScaleFactor" = 1.25;
      "kdeglobals"."KScreen"."ScreenScaleFactors" = "eDP-1=1.25;DP-1=1.25;HDMI-1=1.25;DP-2=1.25;HDMI-2=1.25;";
      "kdeglobals"."Shortcuts"."Quit" = "";
      "kdeglobals"."WM"."activeBackground" = "250,244,237";
      "kdeglobals"."WM"."activeBlend" = "250,250,250";
      "kdeglobals"."WM"."activeFont" = "JetBrainsMono Nerd Font Mono,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."WM"."activeForeground" = "0,0,0";
      "kdeglobals"."WM"."inactiveBackground" = "250,244,237";
      "kdeglobals"."WM"."inactiveBlend" = "250,250,250";
      "kdeglobals"."WM"."inactiveForeground" = "1,1,1";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{49c5a867-e927-4fb8-9596-5da733d8473e}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{4edb9288-e9f0-4c68-9ebe-248436d26162}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{1fe8e8a9-969c-41d1-8c7c-4a8be12965ff}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{6e720b9e-2f37-424c-a5e8-68bb63cac2e3}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{0906a346-ef78-444c-9e65-8ada82f631be}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{3e54954d-a75c-4393-9e6e-07fe7836931d}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{1d1d3773-bbb9-4513-b5ea-7b6e0f233aa2}";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" = "/nix/store/83y93kk4mlk06j69w3s236f005yzvclw-plasma-workspace-wallpapers-5.27.11/share/wallpapers/ColdRipple/";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage" = "/nix/store/83y93kk4mlk06j69w3s236f005yzvclw-plasma-workspace-wallpapers-5.27.11/share/wallpapers/ColdRipple/";
      "ksplashrc"."KSplash"."Engine" = "none";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "4a33de2a-0c37-41c0-97bd-fe29a6727d2b";
      "kwinrc"."Desktops"."Id_2" = "bb978e2f-8a22-4cee-9067-a3613bc949a0";
      "kwinrc"."Desktops"."Id_3" = "89d8ac57-e5c7-44e8-8bd5-399d22d49dd7";
      "kwinrc"."Desktops"."Id_4" = "3b1c9c8f-44e3-4a19-a3c2-9ca72225d11b";
      "kwinrc"."Desktops"."Id_5" = "31245f1b-2d03-4ac3-bde6-047dd9033cd7";
      "kwinrc"."Desktops"."Id_6" = "866d6239-f660-48e2-b569-427946f73792";
      "kwinrc"."Desktops"."Id_7" = "2f6cd354-1a93-4512-a715-b9cbd48c3049";
      "kwinrc"."Desktops"."Id_8" = "d46630d4-3a40-4a25-a800-c19437fefe69";
      "kwinrc"."Desktops"."Id_9" = "22253082-3107-4dbd-86c7-5bf5a4e14c01";
      ...
      "kwinrc"."Tiling.37a505c8-eb62-52c0-8775-c030a2343448"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/213a9620-187e-58a6-b80b-85d8fb95dfce"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/37a505c8-eb62-52c0-8775-c030a2343448"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/42b89f84-17a6-5724-a981-ceb9d0771500"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/51b0d8cd-bbd3-59f2-8435-3354335bd7c6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/53761535-973a-5d2c-8366-0cc4d615029c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/704433d5-4a35-52ae-bdda-1d9e0e3d19fa"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/707e0d36-1a1a-5cee-80d0-4bd2f41fecdb"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/7e591395-ca97-5afb-a17e-2ab0cc2cf45e"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/8d69b116-1825-5677-895d-cb67d0b97bda"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/9c8634c8-b3bf-56d4-b51f-61cbf5420e97"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e13d15bd-4a32-5b9d-a61c-15cbf93f3abf"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e35dd98d-994d-56c1-b1b4-239bb3187e27"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
